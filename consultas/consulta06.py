...
def buildC6(frame):
    ...
    ctk.CTkLabel(izq, text="Zonas Más Caras", font=("Arial", 20, "bold"), text_color="white").pack(anchor="w", pady=(0, 20))
    ctk.CTkLabel(izq, text="Top 5 códigos postales con mayor precio promedio.", text_color="#7b7f96").pack(anchor="w", pady=(0, 15))
    ...
    def ejecutar():
        ...
        top_zips.plot(kind="barh", color="#10b981", ax=ax)
        
        ax.set_title("Top 5 Códigos Postales Más Caros", color="white")
        ax.set_xlabel("Precio Promedio ($)", color="white")
        ax.set_ylabel("Código Postal", color="white")

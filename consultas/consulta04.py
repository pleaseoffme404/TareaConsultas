...
def buildC4(frame):
    ...
    ctk.CTkLabel(izq, text="Tipos de Propiedad", font=("Arial", 20, "bold"), text_color="white").pack(anchor="w", pady=(0, 20))
    ctk.CTkLabel(izq, text="Gráfico de pastel sobre categorías de propiedades.", text_color="#7b7f96").pack(anchor="w", pady=(0, 15))
    ...
    def ejecutar():
        ...
        conteo_tipo.plot(kind='pie', autopct='%1.1f%%', startangle=90, ax=ax, textprops={'color':"white"}, colors=["#4f8ef7", "#10b981", "#8b5cf6", "#f75f5f"])
        
        ax.set_title("Distribución por Tipo", color="white")
        ax.set_ylabel("")
        fig.tight_layout()
        ...
        lbl_mensaje.configure(text="Gráfico generado", text_color="#10b981")

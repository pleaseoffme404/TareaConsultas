...
def buildC5(frame):
    ...
    ctk.CTkLabel(izq, text="Precio por Habitaciones", font=("Arial", 20, "bold"), text_color="white").pack(anchor="w", pady=(0, 20))
    ctk.CTkLabel(izq, text="Promedio de precio según número de cuartos.", text_color="#7b7f96").pack(anchor="w", pady=(0, 15))
    ...
    def ejecutar():
        ...
        promedios.plot(kind="bar", color="#ff7a7a", ax=ax)
        
        ax.set_title("Precio Promedio vs Habitaciones", color="white")
        ax.set_xlabel("Número de Habitaciones", color="white")
